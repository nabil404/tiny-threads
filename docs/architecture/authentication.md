...
As-built reference for how authentication actually works in `apps/api` today.
See `.agents/skills/backend-engineer/SKILL.md` for the tenancy-isolation rules (RLS, `withTenant`) this flow depends on.
