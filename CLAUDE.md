...
This file provides guidance to Claude Code (claude.ai/code) when working in the **Tiny Threads** repository.
...
- **`apps/api`** — NestJS 11 backend providing core APIs, authentication, PostgreSQL Row-Level Security (RLS) multi-tenancy, error handling, provider ports, and domain services.
  - **See detailed guide**: [`apps/api/CLAUDE.md`](apps/api/CLAUDE.md)
...
|---|---|---|
| **Backend API** (`apps/api`) | NestJS 11, PostgreSQL 16, RLS, TypeORM | [`apps/api/CLAUDE.md`](apps/api/CLAUDE.md) |
| **Admin Web** (`apps/admin-web`) | Vite, React 19, Redux Toolkit, Tailwind v4 | [`apps/admin-web/CLAUDE.md`](apps/admin-web/CLAUDE.md) |
